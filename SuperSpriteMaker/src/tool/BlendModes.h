...
struct Blend 
{
    static PixelRGBA8 apply(BlendMode mode, const PixelRGBA8& dst, const PixelRGBA8& src, uint8_t srcOpacity = 255);
...
private:
    ...
    static PixelRGBA8 composite(const PixelRGBA8& dst, const PixelRGBA8& src, uint8_t srcOpacity, BlendMode mode);
};
